		...
		<div class="page-in-container">
			...
			<div class='container-con-block darkmode-block'>
				<div class='container-con-wrapper'>
					...
					<div class='container-tx2-block darkmode-txt'>
						<p>
						-ban [@user] [причина] - Дать бан <br>
						-kick [@user] [причина] - Дать кик <br>
						-mute [@user] [время] - Дать мут <br>
						-poll - Сделать голосование <br>
						-giveaway - Сделать конкурс <br>
						-clear [Количество сообщений] - Удалить сообщения
						</p>
					</div>
				</div>
			</div>
			<div class='container-con-block darkmode-block'>
				<div class='container-con-wrapper'>
					...
					<div class='container-tx2-block darkmode-txt'>
						<p>
						-iq - Узнать свой IQ <br>
						-memes - Рандом мем <br>
						-random - Рандомная цифра<br>
						-coin - Подбросить монетку<br>
						-pat [@user] - RP команда<br>
						-kiss [@user] - RP команда<br>
						-kill [@user] - RP команда<br>
						-say - Сказать от именни бота<br>
						-avatar (@user) - Посмотреть аватарку<br>
						-panda - Фотография панды<br>
						-cat - Фотография кота<br>
						-fox - Фотография лисы<br>
						-koala - Фотография коалы<br>
						-dog - Фотография собаки<br>
						</p>
					</div>
				</div>
			</div>
			<div class='container-con-block darkmode-block'>
				<div class='container-con-wrapper'>
					...
					<div class='container-tx2-block darkmode-txt'>
						<p>
						-play - Включить песню<br>
-stop - Остановить песню<br>
-pause - Поставить на паузу песню<br>
-start - Продолжить проигрование песни<br>
-leave - Отключить бота<br>
						</p>
					</div>
				</div>
			</div>
			<div class='container-con-block darkmode-block'>
				<div class='container-con-wrapper'>
					...
					<div class='container-tx2-block darkmode-txt'>
						<p>
						-lvl - Посмотреть свой уровень<br>
-leader - Посмотреть топ по уровню<br>
-setlvl - Выдать уровень<br>
						</p>
					</div>
				</div>
			</div>
			<div class='container-con-block darkmode-block'>
				<div class='container-con-wrapper'>
					...
					<div class='container-tx2-block darkmode-txt'>
						<p>
						-help - Посмотреть команды бота<br>
-support - Написать в поддержку<br>
-user - Посмотреть информацию о пользователе<br>
-info - Узнать информацию о боте<br>
						</p>
					</div>
			</div>
		</div>
